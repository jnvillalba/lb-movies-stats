let Vol8 = [
  ...
  },
  {
    ...
    writers: ["Luis Ortega", "Rodolfo Palacios", "Fabian Casas"],
    actors: [
  ...
  },
  {
    ...
    actors: [
      ...
      "Pedro Arturo Calveyra",
      "Mariela Noemi Magenta",
      "Marcelo Fabio Carte",
      "Guadalupe Docampo",
      "Juliana Giambroni",
    ],
  },
  {
    ...
    writers: ["Michael Herr", "Stanley Kubrick", "Gustav Hasford"],
    actors: [
      "Matthew Modine",
      "Adam Baldwin",
      "Vincent D'Onofrio",
  ...
  {
    name: "Trenque Lauquen - Parte 1",
    year: "2020",
    directors: ["Laura Citarella"],
    writers: ["Laura Paredes", "Laura Citarella"],
    actors: [
      "Laura Paredes",
      "Ezequiel Pierri",
      "Rafael Spregelburd",
  ...
  },
  {
    ...
    actors: [
      ...
      "Acoyani Chacon",
      "Angeles Woo",
      "Alejandro De Los Monteros",
      "Robert 'Rock' Galotti",
      "Braulio Iara",
      "Alex Briseño",
      "Binah Heike Anne Jauand Martínez",
      "Bruno Gabriel Moreno Martínez",
      "Sebastián Andres León Colmenares",
      "Olaf Alejandro Velazquez Uribe",
      "Hugo Ramírez",
      "Naidelin Landero",
      "Armando Said",
      "Sara Ovando",
  ...
  },
  {
    ...
    writers: ["Peter Farrelly", "Ricky Blitt"],
    actors: [
  ...
  },
  {
    ...
    writers: ["Don Rhymer", "Matt Corman", "Chris Ord"],
    actors: [
      "Danny DeVito",
      "Matthew Broderick",
      "Kristin Davis",
  ...
  },
  {
    ...
    year: "2014",
    directors: ["Edward Zwick"],
    writers: ["Christopher Wilkinson", "Stephen J Rivele", "Steven Knight"],
    actors: [
      "Tobey Maguire",
      "Peter Sarsgaard",
      "Liev Schreiber",
  ...
  },
  {
    ...
    writers: ["Ariel Gurevich", "Daniel Burman"],
    actors: [
      "Penélope Guerrero",
      "Juan Minujín",
      "Alejandra Flechner",
  ...
  {
    name: "Simon of the Mountain",
    year: "2024",
    directors: ["Federico Luis"],
    writers: ["Federico Luis", "Agustin Toscano", "Tomas Murphy"],
    actors: [
      "Lorenzo Ferro",
      "Pehuén Pedre",
      "Kiara Supini",
